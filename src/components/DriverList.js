                    ...
                    <div className="col-md-12">
                        <div className="table-responsive">
                            <div className='p-4 grid grid-cols-2 pb-8'>
                                <div><span className='text-2xl font-bold'>Driver List</span>
                                <span className="font-bold p-4">Home </span></div>
                                <div className="col-auto float-end ml-auto">
                                    <Link
                                        className="inline-flex items-center bg-black font-semibold border-0 py-1 px-3 focus:outline-none hover:bg-gray-700 rounded-full text-white mt-4 md:mt-0"
                                        to="/driverdetails"
                                    >
                                        <i className="fa fa-plus mr-2"/> Driver Details
                                    </Link>
                                </div>
                            </div>
                            <Table
